...
<?php
    ...
    $insertsalesinvoice="SELECT * from sales_invoice";
    ...
    while ($numofrows != 0) 
    {
      ...
      $myArray1[$j][6] = $row['EngineCapacity'];
      $myArray1[$j][7] = $row['Car_Price'];
...
<script>
     ...
     document.getElementById('salesinv').style.border="4px solid black";
      ...
      document.getElementsByClassName('headings')[6].innerHTML="Engine CC";
