...
<?php
    ...
    $insertsalesinvoice="SELECT * from sales_rent_invoice"; 
    ...
    while ($numofrows != 0) 
    {
      ...
      $myArray1[$j][0] = $row['CSellerName'];
      $myArray1[$j][1] = $row['Csellerphone'];
      $myArray1[$j][2] = $row['Registration_No'];
      $myArray1[$j][3] = $row['ModelYear'];
      $myArray1[$j][4] = $row['color'];
      $myArray1[$j][5] = $row['Brand'];
      $myArray1[$j][6] = $row['Car_Price'];
      $myArray1[$j][7] = $row['customerName'];
      $myArray1[$j][8] = $row['custmrphoneNo'];
...
<script>
     ...
     document.getElementById('salesinv').style.border="4px solid black";
      ...
      document.getElementById('customernamee').innerHTML=myArray1[0][7];
      document.getElementById('customerphone').innerHTML=myArray1[0][8];
      ...
      document.getElementsByClassName('headings')[6].innerHTML="Amount Per Day";
      var sum=0;
      for(var i=0;i<myArray1.length;i++)
       {
          ...
          sum=sum+Number(myArray1[i][6]);
       }
       document.getElementsByClassName('d')[5].innerHTML+="<br>"+"<b>"+"Total";
       document.getElementsByClassName('d')[6].innerHTML+="<br>"+"<b>"+sum +" "+"RS";
       var d=(17/100)*sum;
