...
$conn = mysqli_connect($servername, $username, $password, $dbname);
    ...
    $RentCarinventory="SELECT * 
    FROM RentCars  
    where RentCars.OwnerPhoneNO= $getphonn";

    $Result = mysqli_query($conn, $RentCarinventory);
    ...
    while ($numofrows != 0) 
    {
     ...
     if ($array2) 
     {
       ...
       {
         $rg=$arr[$i];
         $deletedataofcar="Delete from RentCars where RentCars.Registration_No='$rg'";
...
<script>
  ...
  xhr.open("POST", "RentCarinventory.php");
